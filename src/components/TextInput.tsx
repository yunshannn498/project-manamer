          ...
          {isVoiceMode ? (
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800 placeholder-gray-400"
              />
              <button
                type="submit"
                disabled={!text.trim()}
